...
IntelliJ IDEA, PyCharm, WebStorm, PhpStorm, Rider, GoLand y Android Studio comparten la misma integración con Git en el menú **Git** (o **VCS**).

## Flujo principal

- **Git > Clone** crea el repositorio local; **VCS > Enable Version Control Integration** inicia uno en un proyecto existente.
- La ventana **Commit** enumera los cambios, los agrupa en changelists y prepara archivos o hunks. Debajo están el cuadro de mensaje y los botones **Commit** / **Commit and Push**.
