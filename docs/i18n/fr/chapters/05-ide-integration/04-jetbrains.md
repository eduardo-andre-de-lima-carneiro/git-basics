...
IntelliJ IDEA, PyCharm, WebStorm, PhpStorm, Rider, GoLand et Android Studio partagent la même intégration Git sous le menu **Git** (ou **VCS**).

## Flux principal

- **Git > Clone** crée le dépôt local ; **VCS > Enable Version Control Integration** en démarre un dans un projet existant.
- La fenêtre **Commit** liste les changements, les regroupe en changelists et prépare des fichiers ou des hunks. Une zone de message et les boutons **Commit** / **Commit and Push** se trouvent en dessous.
